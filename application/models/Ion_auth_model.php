...
class Ion_auth_model extends CI_Model
{
	...
	**/
	 ...
	 * @author aditya menon
	*/
	public function create_group($group_name = FALSE, $group_description = '', $permission = FALSE, $additional_data = array())
	{
	...
	**/
	...
	public function has_access($menu, $group_id = FALSE)
	{
		$menu_id = $this->_get_menu_id($menu);
		if ($group_id == FALSE) {
			$group_id = array();
			foreach ($this->ion_auth->get_users_groups()->result() as $row) {
				$group_id[] = $row->id;
			}
		...
		$this->db->where("group_id IN ($group_id)");
